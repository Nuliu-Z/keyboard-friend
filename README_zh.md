...
如果对 J-Link 命令不熟悉，可以使用 [nRF Connect for Desktop(Programmer app)](https://docs.nordicsemi.com/bundle/swtools_docs/page/app/pc-nrfconnect-programmer/index.html)，或者直接问问AI “如何烧录hex格式固件到nrf52840” :)

固件列表，见 [Releases](https://github.com/Nuliu-Z/keyboard-friend/releases)。
